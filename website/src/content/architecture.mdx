...
- **Semantic** (optional) — Embedding-based cosine similarity against pre-computed indices. Requires `embedding_model` to be configured. Validates dimension compatibility between query and stored embeddings.
